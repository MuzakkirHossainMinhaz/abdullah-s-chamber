...
import SocialLink from '../Signin/SocialLink/SocialLink';
...
const Register = () => {
    ...
    return (
        <div className='container my-5 register shadow p-5'>
            ...
            <div>
                <p className='text-center mt-3'>Already have an account? <Link to='/signin' className='text-warning' style={{ cursor: "pointer" }}>Signin</Link></p>
            </div>
        </div>
    );
};
